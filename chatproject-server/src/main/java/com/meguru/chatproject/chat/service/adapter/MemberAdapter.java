...
import static com.meguru.chatproject.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.meguru.chatproject.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
